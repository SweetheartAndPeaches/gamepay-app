...
### POST /api/tasks/payin/upload-proof
...
4. 完成代收，上传转账凭证
5. 点击"确认已收到款项"，佣金：7.5 元
6. 可用余额：1007.5 元，冻结余额：0 元
...
1. 用户领取代收任务
2. 查看付款方信息（姓名、账号等）
3. 完成代收后，在任务详情弹窗中输入转账凭证 URL
4. 点击"上传凭证"按钮
5. 上传成功后，显示"已上传转账凭证"提示
6. 点击"已收到款项"按钮完成任务
...
A: 领取代收任务后，在任务详情弹窗中会显示付款方信息。完成代收后，在弹窗中输入转账凭证图片 URL，然后点击"上传凭证"按钮。

### Q: 为什么需要上传转账凭证？

A: 上传转账凭证是为了证明您已经收到付款，这是完成代收任务的必要步骤。

### Q: 可以上传什么格式的凭证？

A: 支持通过 URL 引入的图片格式（如 JPG、PNG 等）。您需要先将凭证上传到对象存储或其他可访问的 URL。
